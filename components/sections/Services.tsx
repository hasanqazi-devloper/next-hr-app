      ...
      <div className="max-w-7xl 2xl:max-w-[110rem] mx-auto px-6 relative z-10">
        ...
        <div className="mb-8 md:mb-12 pt-0 text-center">
          <motion.h3
            ...
            viewport={{ once: true }}
            className="mt-3 text-[2.3rem]  md:text-[2.5rem] lg:text-[2.5rem] 2xl:text-[3.2rem] font-black tracking-tighter leading-[1.1] lg:leading-none text-white pr-4 py-1"
          >
            Our {" "}
                  ...
                  <Link href={item.link} className="relative z-10 flex items-center justify-between gap-6 py-8 2xl:py-16 px-2">
                    ...
                    <div className="relative flex items-center gap-6">
                      ...
                      <div className="relative z-10">
                        ...
                        <h4 className={`!text-lg sm:!text-xl md:!text-xl lg:!text-2xl 2xl:!text-4xl font-black tracking-tight leading-snug transition-all duration-300 ${isActive ? "text-white translate-x-1.5" : "text-zinc-500 hover:text-zinc-400"
                          }`}>
                          {item.title}
                        </h4>
                        ...
                        >
                          ...
                          <p className="text-white text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-3xl mx-auto lg:mx-0 opacity-90">
                            {item.desc}
                          </p>
                        </motion.div>
                      </div>
