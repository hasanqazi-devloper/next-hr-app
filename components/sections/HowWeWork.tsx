                  ...
                  <div className="w-full md:w-[45%] pl-8 md:pl-0">
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-4">
                        ...
                        <p className="text-sm md:text-base 2xl:text-lg 4xl:text-2xl text-zinc-300 group-hover:text-white opacity-90 group-hover:opacity-100 transition-all duration-300 leading-relaxed font-normal">
                          {step.desc}
                        </p>
                      </div>
