...
import { motion } from "framer-motion"; // Matching Privacy page animation ecosystem
import {
  Mail,
  Phone,
  Send,
...
export default function ContactPage() {
  ...
  return (
    /* 🎯 JUGAR LOCKED: Master layout wrapper structure with exact negative margins to pull it up under the navbar and kill the gap completely */
    <main className="min-h-screen bg-[#020617] text-white overflow-x-hidden selection:bg-blue-600 -mt-24 md:-mt-28 lg:-mt-32">
      ...
      <section className="relative z-10 max-w-[1400px] 2xl:max-w-[1700px] mx-auto px-6 py-12 pb-24">
        <div className="flex flex-col lg:flex-row gap-8 2xl:gap-12 items-stretch">
          ...
          <div className="flex-[1.8] bg-gradient-to-br from-blue-600/10 to-transparent border border-white/5 rounded-[2.5rem] p-8 md:p-12 2xl:p-16 shadow-xl backdrop-blur-sm">
